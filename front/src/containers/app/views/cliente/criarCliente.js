...
class criarCliente extends Component {
    ...
    async criarCliente (){
      const {data} = await Servico.post("/criar-cliente",{nome:this.state.nome, login: this.state.login, senha: this.state.senha});
      this.setState({
                    ...
                    <Card>
                      <CardBody><Col xs="3" md="3" style={{ paddingBottom: "20px" }}>
                        ...
                        <div className="form-actions">
                          <Button onClick={this.criarCliente.bind(this)} type="submit" color="primary">Salvar</Button>
