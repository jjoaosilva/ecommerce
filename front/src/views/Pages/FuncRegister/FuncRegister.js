...
class FuncRegister extends Component {
  ...
  constructor(props) {
    ...
    async criarCliente (){
      if(this.state.senha == this.state.confirmarSenha){
        const {data} = await Auth.post("/criar-funcionario",{nome:this.state.nome, login: this.state.email, senha: this.state.senha, salario: this.state.salario});
        this.setState({
              ...
              <Card className="mx-4">
                <CardBody className="p-4">
                  ...
                  <Form>
                    ...
                    <InputGroup className="mb-3">
                      <InputGroupAddon addonType="prepend">
                        <InputGroupText><i className="cui-dollar"></i></InputGroupText>
                      </InputGroupAddon>
                      <Input type="text" placeholder="Salario" autoComplete="salario"  value={this.state.salario} onChange={(event) => this.setState({salario: event.target.value})}/>
                    </InputGroup>
